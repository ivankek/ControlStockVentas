-- Remove unused safety stock fields. Stock now consists of physical and reserved units.
begin;
alter table public.supplier_inventory drop column if exists safety_stock;
alter table public.inventory_movements drop column if exists safety_before;
alter table public.inventory_movements drop column if exists safety_after;
